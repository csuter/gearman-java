...
/**
 *
 * A Gearman Worker is reponsible for executing jobs it receives from the Job
...
public interface GearmanWorker {
    ...
    /**
     * Send an echo reguest to the specified {@link GearmanJobServerConnection},
    ...
    /**
     * Determin if the worker is currently executing the work looop.
     *
